...
- **Empty states** should use the shared `EmptyState` component — the goal, not yet fully the reality: `PipelineSnapshot.tsx` and `workflows/page.tsx` still hand-roll their own as of 2026-09-05. Use the shared one for anything new; feel free to migrate either of those two when you're already in that file.
