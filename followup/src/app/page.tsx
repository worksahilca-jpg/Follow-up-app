    ...
    <div>
      ...
      <section className="relative max-w-6xl mx-auto px-6 pt-16 pb-20 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <FadeIn>
          ...
          <div className="mt-8 flex gap-3">
            <Link
              href="/signin"
              className="rounded-lg px-5 py-3 text-sm font-medium text-white transition-transform hover:scale-[1.03]"
              style={{ backgroundColor: "var(--rust)" }}
            >
              Get started
            </Link>
            <a href="#how-it-works" className="rounded-lg border border-line px-5 py-3 text-sm font-medium transition-colors hover:bg-card">
              See how it works
            </a>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 border-t border-line text-center">
        <FadeIn>
          ...
          <Link
            href="/signin"
            className="inline-block mt-6 rounded-lg px-6 py-3 text-sm font-medium text-white transition-transform hover:scale-[1.03]"
            style={{ backgroundColor: "var(--rust)" }}
          >
            Get started
          </Link>
