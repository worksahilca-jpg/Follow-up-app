...
/** Accordion with the first answer open by default, so the section never reads as a list of closed doors. */
export default function FaqLight({ items }: { items: { q: string; a: string }[] }) {
