 ...
 */
export const CHART_AXIS_COLOR = "#78716c"; // --ink-soft
export const CHART_GRID_COLOR = "#e7e1d9"; // --line

export const CHART_TOOLTIP_STYLE = {
  backgroundColor: "#ffffff", // --card
  border: "1px solid #e7e1d9", // --line
  borderRadius: 8,
  fontSize: 13,
};

export const CHART_PRIMARY = "#7a2e3a"; // --rust
export const CHART_INK = "#231f1c"; // --ink
